...
// }
	...
	function save_journal_3(){
			...
			if(!in_array($k,array('id'))  && !is_array($_POST[$k])){
				...
				if(!is_null($v))
				{
					if(($k === 'vat_deduction') && ($v != 0)){
						$amt_vatitsc = $amt_vatitsc + $v;
						$amt_vatit = $amt_vatit + $v;
						$amt_vat = $amt_vat + $v;
						$flag_vat = 1;
					...
					if(($k === 'it_deduction') && ($flag_vat === 1) && ($v != 0)){
						$amt_vatitsc = $amt_vatitsc + $v;
						$amt_vatit = $amt_vatit + $v;
						$flag_it = 1;
					...
					if(($k === 'sc_deduction') && ($flag_vat === 1) && ($flag_it === 1) && ($v != 0)){
						$amt_vatitsc = $amt_vatitsc + $v;
						$flag_sc = 1;
		...
		if (($flag_vat === 1) && ($flag_it === 1) && ($flag_sc === 1)) 
			$sql_2 = "INSERT INTO `journal_entries`(`journal_type`, `new`, `debit_count`, `credit_count`, `journal_date`, `voucher_number`, `description`, `source_fund`, `dli_type`, `component_number`, `category_number`, `payee_name`, `gross_amt`, `vat_deduction`, `it_deduction`, `sc_deduction`, `security_deduction`,`commission`, `chq_number`, `pkg_number`, `exp_type`, `exp_group`, `code`, `user_id`, `year_id`) VALUES ('dv', '0', '111', '1', '{$journal_date}', '{$voucher_number}', '{$description}', '{$source_fund}', '{$dli_type}','{$component_number}','{$category_number}','13','{$amt_vatitsc}','{$vat_deduction}','{$it_deduction}','{$sc_deduction}','{$security_deduction}','{$commission}','{$chq_number_tax}','{$pkg_number}','{$exp_type}', '{$exp_group}','{$code1}','{$user_id}', '{$year_id}' ) ";
		else if (($flag_vat === 1) && ($flag_it === 1)) 
				$sql_2 = "INSERT INTO `journal_entries`(`journal_type`, `new`, `debit_count`, `credit_count`, `journal_date`, `voucher_number`, `description`, `source_fund`, `dli_type`, `component_number`, `category_number`, `payee_name`, `gross_amt`, `vat_deduction`, `it_deduction`, `sc_deduction`, `security_deduction`,`commission`, `chq_number`, `pkg_number`, `exp_type`, `exp_group`, `code`, `user_id`, `year_id`) VALUES ('dv', '0', '11', '1', '{$journal_date}', '{$voucher_number}', '{$description}', '{$source_fund}', '{$dli_type}','{$component_number}','{$category_number}','13','{$amt_vatit}','{$vat_deduction}','{$it_deduction}','{$sc_deduction}','{$security_deduction}','{$commission}','{$chq_number_tax}','{$pkg_number}','{$exp_type}', '{$exp_group}','{$code1}','{$user_id}', '{$year_id}' ) ";
			else if ($flag_vat === 1)			
				$sql_2 = "INSERT INTO `journal_entries`(`journal_type`, `new`, `debit_count`, `credit_count`, `journal_date`, `voucher_number`, `description`, `source_fund`, `dli_type`, `component_number`, `category_number`, `payee_name`, `gross_amt`, `vat_deduction`, `it_deduction`, `sc_deduction`, `security_deduction`,`commission`, `chq_number`, `pkg_number`, `exp_type`, `exp_group`, `code`, `user_id`, `year_id`) VALUES ('dv', '0', '1', '1', '{$journal_date}', '{$voucher_number}', '{$description}', '{$source_fund}', '{$dli_type}','{$component_number}','{$category_number}','13','{$amt_vat}','{$vat_deduction}','{$it_deduction}','{$sc_deduction}','{$security_deduction}','{$commission}','{$chq_number_tax}','{$pkg_number}','{$exp_type}', '{$exp_group}','{$code1}','{$user_id}', '{$year_id}' ) ";
