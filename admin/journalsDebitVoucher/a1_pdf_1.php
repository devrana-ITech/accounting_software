...
if ($journals->num_rows > 0){
	while($row = $journals->fetch_assoc()){
	   if ($row['Crt'] != 0) {
			...
			$data .= '<td class="cl2" style="padding: 3px;">'.number_format($row['Crt'], 2).'</td>';
...
if ($total_opening_qtr != 0){
	$data .= '<td class="cl2" style="padding: 3px;">'.number_format($total_opening_qtr, 2).'</td>';
	$data .= '<td class="cl3" style="padding: 3px;">'.number_format($total_opening_qtr, 2).'</td>';
}else{
	$data .= '<td class="cl2" style="padding: 3px;">--</td>';
	$data .= '<td class="cl3" style="padding: 3px;">--</td>';
}
if ($total_opening_ytd != 0){
	$data .= '<td class="cl2" style="padding: 3px;">'.number_format($total_opening_ytd, 2).'</td>';
	$data .= '<td class="cl3" style="padding: 3px;">'.number_format($total_opening_ytd, 2).'</td>';
}else {
	$data .= '<td class="cl2" style="padding: 3px;">--</td>';
	$data .= '<td class="cl3" style="padding: 3px;">--</td>';
}
...
if ($journals->num_rows > 0){
	while($row = $journals->fetch_assoc()){
	   if ($row['Crt'] != 0) {
			$data .= '<td class="cl2" style="padding: 3px;">'.number_format($row['Crt'], 2).'</td>';
			$data .= '<td class="cl3" style="padding: 3px;">'.number_format($row['Crt'], 2).'</td></tr>';
...
$data .= '<tr><td class="cl1" style="padding: 3px;"><b>Total Funds Available</b></td><td class="cl2">'.number_format($total_opening_qtr, 2).'</td><td class="cl2">'.number_format($total_opening_qtr, 2).'</td><td class="cl2">'.number_format($total_opening_ytd, 2).'</td><td class="cl2">'.number_format($total_opening_ytd, 2).'</td><td class="cl2">'.number_format($total_funds_cumulative, 2).'</td><td class="cl2">'.number_format($total_funds_cumulative, 2).'</td></tr>';
...
$data .= '<tr><td class="cl1" style="padding: 3px;"><b>Uses of Funds Total</b></td><td class="cl2">'.number_format($total_qtr_exp, 2).'</td><td class="cl2">'.number_format($total_qtr_exp, 2).'</td><td class="cl2">'.number_format($total_ytd_exp, 2).'</td><td class="cl2">'.number_format($total_ytd_exp, 2).'</td><td class="cl2">'.number_format($total_exp_cumulative, 2).'</td><td class="cl2">'.number_format($total_exp_cumulative, 2).'</td></tr>';
...
$data .= '<tr><td class="cl1" style="padding: 3px;"><b>Closing Balance Total</b></td><td class="cl2">'.number_format($bal_qtr, 2).'</td><td class="cl2">'.number_format($bal_qtr, 2).'</td><td class="cl2">'.number_format($bal_ytd, 2).'</td><td class="cl2">'.number_format($bal_ytd, 2).'</td><td class="cl2">'.number_format($bal_cum, 2).'</td><td class="cl2">'.number_format($bal_cum, 2).'</td></tr>';
...
if ($cash_qtr > 0){
	$data .= '<td class="cl2">'.number_format($bal_qtr_, 2).'</td>';
	$data .= '<td class="cl2">'.number_format($bal_qtr_, 2).'</td>';
}
else {
	$data .= '<td class="cl2">'.number_format($bal_qtr, 2).'</td>';
	$data .= '<td class="cl2">'.number_format($bal_qtr, 2).'</td>';
}
if ($cash_ytd > 0) {
	$data .= '<td class="cl2">'.number_format($bal_ytd_, 2).'</td>';
	$data .= '<td class="cl2">'.number_format($bal_ytd_, 2).'</td>';
}
else {
	$data .= '<td class="cl2">'.number_format($bal_ytd, 2).'</td>';
	$data .= '<td class="cl2">'.number_format($bal_ytd, 2).'</td>';
}
if ($cash_cum > 0) {
	$data .= '<td class="cl2">'.number_format($bal_cum_, 2).'</td>';
	$data .= '<td class="cl2">'.number_format($bal_cum_, 2).'</td></tr>';
}
else {
	$data .= '<td class="cl2">'.number_format($bal_cum, 2).'</td>';
	$data .= '<td class="cl2">'.number_format($bal_cum, 2).'</td></tr>';
}


$data .= '<tr><td class="cl1" style="padding: 3px;">Advance at Petty Cash</td>';
if ($cash_qtr > 0){
	$data .= '<td class="cl2">'.number_format($cash_qtr, 2).'</td>';
	$data .= '<td class="cl2">'.number_format($cash_qtr, 2).'</td>';
}
else {
...
if ($cash_ytd > 0) {
	$data .= '<td class="cl2">'.number_format($cash_ytd, 2).'</td>';
	$data .= '<td class="cl2">'.number_format($cash_ytd, 2).'</td>';
} else {
	$data .= '<td class="cl2">--</td>';
	$data .= '<td class="cl2">--</td>';
...
if ($cash_cum > 0) {
	$data .= '<td class="cl2">'.number_format($cash_cum, 2).'</td>
	<td class="cl2">'.number_format($cash_cum, 2).'</td></tr>';
} else {
	$data .= '<td class="cl2">--</td>';
	$data .= '<td class="cl2">--</td></tr>';
}

$data .= '<tr><td class="cl1" style="padding: 3px;"><b>Total Fund Available</b></td><td class="cl2">'.number_format($bal_qtr, 2).'</td><td class="cl2">'.number_format($bal_qtr, 2).'</td><td class="cl2">'.number_format($bal_ytd, 2).'</td><td class="cl2">'.number_format($bal_ytd, 2).'</td><td class="cl2">'.number_format($bal_cum, 2).'</td><td class="cl2">'.number_format($bal_cum, 2).'</td></tr>';
//////////////////////
