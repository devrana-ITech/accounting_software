...
<div class="container-fluid">
    <form action="" id="journal-form">
		...
		<input type="hidden" name="voucher_num_jv" id="voucher_num_jv" value="<?= $value1 ?>">
        ...
        <div class="row">
			...
			<div class="col-md-2 form-group">
                IT Deduction<input style="background-color: #f0dcf7;" type="number" id="it_deduction" name="it_deduction" class="form-control form-control-sm rounded-0" value="<?= isset($it_deduction) ? $it_deduction : "0" ?>" onkeyup="net_pay()" required>
            </div>
        </div>
		<div class="row">
			<div class="col-md-2 form-group">
                Service Charge Deduction<input style="background-color: #f0dcf7;" type="number" id="sc_deduction" name="sc_deduction" class="form-control form-control-sm rounded-0" value="<?= isset($sc_deduction) ? $sc_deduction : "0" ?>" onkeyup="net_pay()" required>
            </div>
			<div class="col-md-2 form-group">
			...
			<div class="col-md-1 form-group">
                Advice VAT/Tax<input style="background-color: #f0dcf7;" type="text" id="chq_number_tax" name="chq_number_tax" class="form-control form-control-sm rounded-0" value="<?= isset($chq_number_tax) ? $chq_number_tax : "" ?>" required>
            </div>
			<div class="col-md-2 form-group">
        ...
        <div class="row">
			...
			<div class="col-md-2 form-group">
                Credit<input style="background-color: #f0dcf7; font-size: 18px; width: 100%;" type="number" step="any" id="credit" class="form-control form-control-sm rounded-0" value="" onkeyup="sync()">
...
*/
    ...
    $(function(){
        ...
        $('#uni_modal #journal-form').submit(function(e){
            ...
            start_loader();
            $.ajax({
                url:_base_url_+"classes/Master.php?f=save_journal_3",
