...
<p style="text-align: right; margin-top: -50px; margin-bottom: 0px; font-size: 14px;"><i>(Amount in BDT)</i></p>
	...
	<table>
		...
		<tbody>
				...
				$data .= '</tr>
				<tr>
				  <td style="background-color: #f2ebf5; width: 12%; font-size: 12px; text-align: left;"><b>DLI</b></td>
				  <td style="background-color: #f2ebf5; width: 22%; font-size: 12px; text-align: right;"><b>';
				  if ($dli_2 <= 0) $data .= '--'; else $data .= ''.number_format($dli_2, 2).'</b></td>';
				  $data .= '<td style="background-color: #f2ebf5; width: 22%; font-size: 12px; text-align: right;"><b>';
				...
				$data .= '</tr>
				<tr>
				  <td style="background-color: #ffe6e6; width: 12%; font-size: 12px; text-align: left;"><b>Total</b></td>
				  <td style="background-color: #ffe6e6; width: 22%; font-size: 12px; text-align: right;"><b>'.number_format($nondli_dli2, 2).' </b></td>
				  <td style="background-color: #ffe6e6; width: 22%; font-size: 12px; text-align: right;"><b>'.number_format($nondli_dli3, 2).'</b></td>
				  <td style="background-color: #ffe6e6; width: 22%; font-size: 12px; text-align: right;"><b>';
				  if ($nondli_dli4 <= 0) $data .= '--'; else $data .= ''.number_format($nondli_dli4, 2).'</b></td>';
				  $data .= '<td style="background-color: #ffe6e6; width: 22%; font-size: 12px; text-align: right;"><b>'.number_format($grand_total, 2).'</b></td>
				</tr>
		</tbody>
   </table>';
...
$data .= '
<p style="text-align: center; margin-top: 30px; font-size:16px;"><b>Financial Year-wise Expenditures</b></p>
<p style="text-align: right; margin-top: -50px; margin-bottom: 0px; font-size: 14px;"><i>(Amount in BDT)</i></p>
        ...
        <table>
			...
			<tbody>
				<tr>
				  <td style="background-color: #faf5fc; width: 12%; font-size: 12px; text-align: left;"><b>Non-DLI</b></td>
				  <td style="background-color: #faf5fc; width: 22%; font-size: 12px; text-align: right;"><b>'.number_format($nondli_2, 2).'</b></td>
				  <td style="background-color: #faf5fc; width: 22%; font-size: 12px; text-align: right;"><b>'.number_format($nondli_3, 2).'</b></td>
				  <td style="background-color: #faf5fc; width: 22%; font-size: 12px; text-align: right;"><b>'.number_format($nondli_4, 2).'</b></td>	  
				  <td style="background-color: #faf5fc; width: 22%; font-size: 12px; text-align: right;"><b>'.number_format($nondli_total, 2).'</b></td>
				</tr>
				<tr>
				  <td style="background-color: #f2ebf5; width: 12%; font-size: 12px; text-align: left;"><b>DLI</b></td>
				  <td style="background-color: #f2ebf5; width: 22%; font-size: 12px; text-align: right;"><b>';
				...
				<tr>
				  ...
				  <td style="background-color: #ffe6e6; width: 22%; font-size: 12px; text-align: right;"><b>'.number_format($nondli_dli2, 2).'</b></td>
				  <td style="background-color: #ffe6e6; width: 22%; font-size: 12px; text-align: right;"><b>'.number_format($nondli_dli3, 2).'</b></td>
				  <td style="background-color: #ffe6e6; width: 22%; font-size: 12px; text-align: right;"><b>'.number_format($nondli_dli4, 2).'</b></td>
				  <td style="background-color: #ffe6e6; width: 22%;font-size: 12px; text-align: right;"><b>'.number_format($grand_total, 2).'</b></td>
				</tr>
			</tbody>
	   </table> <pagebreak>';
...
$data .= '
<p style="text-align: center; margin-top: 30px; font-size:16px;"><b>FY-wise Expenditures by Main Groups (Non-DLI)</b></p>
<p style="text-align: right; margin-top: -50px; margin-bottom: 0px; font-size: 14px;"><i>(Amount in BDT)</i></p>
        <table>
			<thead>
				<tr>
				  <th style="background-color: #d48104; color: white; width: 20%; font-size: 12px; text-align: left;"><b>Group Name</b></th>
				  <th style="background-color: #d48104; color: white; width: 20%; font-size: 12px; text-align: right;"><b>2021-22</b></th>
				  <th style="background-color: #d48104; color: white; width: 20%; font-size: 12px; text-align: right;"><b>2022-23</b></th>
				  <th style="background-color: #d48104; color: white; width: 20%; font-size: 12px; text-align: right;"><b>2023-24</b></th>
				  <th style="background-color: #d48104; color: white; width: 20%; font-size: 12px; text-align: right;"><b>Total</b></th>
				</tr>
			</thead>		  
			<tbody>
				<tr>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: left;"><b>a) Goods</b></td>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_1_2, 2).'</b></td>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_1_3, 2).'</b></td>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_1_4, 2).'</b></td>	  
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_1_total, 2).'</b></td>
				</tr>
				<tr>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: left;"><b>b) Works</b></td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_2_2 <= 0) $data .= '--'; else $data .= ''.number_format($item_2_2, 2).'</b></td>';
				  $data .= '<td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_2_3, 2).'</b></td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_2_4 <= 0) $data .= '--'; else $data .= ''.number_format($item_2_4, 2).'</b></td>';	  
				  $data .= '<td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_2_total, 2).'</b></td>
				</tr>
				<tr>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: left;"><b>c) Consultants\' Services</b></td>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_3_2, 2).'</b></td>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_3_3, 2).'</b></td>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_3_4, 2).'</b></td>	  
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_3_total, 2).'</b></td>
				</tr>
				<tr>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: left;"><b>d) Non-Consulting Services</b></td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_4_2, 2).'</b></td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_4_3, 2).'</b></td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_4_4, 2).'</b></td>	  
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_4_total, 2).'</b></td>
				</tr>
				<tr>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: left;"><b>e) Training, Workshop</b></td>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_5_2, 2).'</b></td>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_5_3, 2).'</b></td>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_5_4, 2).'</b></td>	  
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_5_total, 2).'</b></td>
				</tr>
				<tr>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: left;"><b>f) Operating Costs</b></td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_6_2, 2).'</b></td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_6_3, 2).'</b></td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_6_4, 2).'</b></td>	  
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($item_6_total, 2).'</b></td>
				</tr>
				<tr>
				  <td style="background-color: #f4f5f2;" colspan="5"><b>g) Grants under Part 3.2(b)</b></td>
				  
				</tr>
				<tr>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: left;"><b>&nbsp;&nbsp;&nbsp;&nbsp;(i) Voucher Program</b></td>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>';
				  ...
				  $data .= '</td>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_7_total <= 0) $data .= '--'; else $data .= ''.number_format($item_7_total, 2).'</b>';
				  $data .= '</td>
				</tr>';
				  
				$data .= '
				<tr>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: left;"><b>&nbsp;&nbsp;&nbsp;(ii) Grant Program</b></td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_8_2 <= 0) $data .= '--'; else $data .= ''.number_format($item_8_2, 2).'</b>';
				  $data .= '</td><td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>';
				...
				$data .= '</tr>
				<tr>
				  <td style="background-color: #ffe6e6; width: 20%; font-size: 12px; text-align: left;"><b>Total</b></td>
				  <td style="background-color: #ffe6e6; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($col_1_total, 2).'</b></td>
				  <td style="background-color: #ffe6e6; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($col_2_total, 2).'</b></td>
				  <td style="background-color: #ffe6e6; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($col_3_total, 2).'</b></td>
				  <td style="background-color: #ffe6e6; width: 20%; font-size: 12px; text-align: right;"><b>'.number_format($col_4_total, 2).'</b></td>
				</tr>
			</tbody>
	   </table>';
...
$data .= '
<p style="text-align: center; margin-top: 30px; font-size:16px;"><b>FY-wise Expenditures by Main Groups (DLI)</b></p>
<p style="text-align: right; margin-top: -50px; margin-bottom: 0px; font-size: 14px;"><i>(Amount in BDT)</i></p>
        <table>
			<thead>
				<tr>
			...
			<tbody>
				...
				<tr>
				  ...
				  $data .= '</td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_2_3_d <= 0) $data .= '--'; else $data .= ''.number_format($item_2_3_d, 2).'</b>';
				  $data .= '</td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_2_4_d <= 0) $data .= '--'; else $data .= ''.number_format($item_2_4_d, 2).'</b>';
				  $data .= '</td>	  
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_2_total_d <= 0) $data .= '--'; else $data .= ''.number_format($item_2_total_d, 2).'</b>';
				  $data .= '</td>
				</tr>
				<tr>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: left;"><b>c) Consultants\' Services</b></td>
				  ...
				  $data .= '</td>	  
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_3_total_d <= 0) $data .= '--'; else $data .= ''.number_format($item_3_total_d, 2).'</b>';
				  $data .= '</td>
				</tr>
				<tr>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: left;"><b>d) Non-Consulting Services</b></td>
				  ...
				  $data .= '</td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_4_3_d <= 0) $data .= '--'; else $data .= ''.number_format($item_4_3_d, 2).'</b>';
				  $data .= '</td>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_4_4_d <= 0) $data .= '--'; else $data .= ''.number_format($item_4_4_d, 2).'</b>';
				  $data .= '</td>	  
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_4_total_d <= 0) $data .= '--'; else $data .= ''.number_format($item_4_total_d, 2).'</b>';
				  $data .= '</td>
				</tr>
				<tr>
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: left;"><b>e) Training, Workshop</b></td>
				  ...
				  $data .= '</td>	  
				  <td style="background-color: #faf5fc; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_5_total_d <= 0) $data .= '--'; else $data .= ''.number_format($item_5_total_d, 2).'</b>';
				  $data .= '</td>
				</tr>
				<tr>
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: left;"><b>f) Operating Costs</b></td>
				  ...
				  $data .= '</td>	  
				  <td style="background-color: #f2ebf5; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($item_6_total_d <= 0) $data .= '--'; else $data .= ''.number_format($item_6_total_d, 2).'</b>';
				  $data .= '</td>
				</tr>
				<tr>
				  <td style="background-color: #f4f5f2;" colspan="5"><b>g) Grants under Part 3.2(b)</b></td>
				...
				<tr>
				  <td style="background-color: #ffe6e6; width: 20%; font-size: 12px; text-align: left;"><b>Total</b></td>
				  <td style="background-color: #ffe6e6; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($col_1_total_d <= 0) $data .= '--'; else $data .= ''.number_format($col_1_total_d, 2).'</b>';
				  $data .= '</td>
				  <td style="background-color: #ffe6e6; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($col_2_total_d <= 0) $data .= '--'; else $data .= ''.number_format($col_2_total_d, 2).'</b>';
				  $data .= '</td>
				  <td style="background-color: #ffe6e6; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($col_3_total_d <= 0) $data .= '--'; else $data .= ''.number_format($col_3_total_d, 2).'</b>';
				  $data .= '</td>
				  <td style="background-color: #ffe6e6; width: 20%; font-size: 12px; text-align: right;"><b>';
				  if ($col_4_total_d <= 0) $data .= '--'; else $data .= ''.number_format($col_4_total_d, 2).'</b>';
				  $data .= '</td>
				</tr>
			</tbody>
	   </table>';
