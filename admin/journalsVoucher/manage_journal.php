...
$qry_year = $conn->query("SELECT max(voucher_number) as vn FROM `journal_entries` where year_id = '$val' and journal_type = 'jv'");
    ...
    <form action="" id="journal-form">
		...
		<div class="row">
			<div class="col-md-5 form-group">
                Component No<br><select id="component_number" name="component_number" required>
			...
			<div class="col-md-5 form-group">
                Category No<br><select id="category_number" name="category_number" required>
                    <option value="" disabled selected></option>
                    <?php 
